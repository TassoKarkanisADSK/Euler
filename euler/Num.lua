...
local numClassMetatable = {
    __call = function( _, a )
        return numMetatable.create( a )
    end,
    ...
    __index = function( obj, key )
        ...
        if key == "alloc" then
            ...
            error( "NumClass: invalid index: " .. key )
        end
    end,

    __newindex = function()
        error( "NumClass: newindex not supported" )
    end,
}

Num = {}
setmetatable( Num, numClassMetatable )
